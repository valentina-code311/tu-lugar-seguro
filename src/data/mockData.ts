export const socialLinks = [
  { id: "1", name: "Instagram", icon: "Instagram", url: "https://instagram.com/psicosexvalendm", active: true },
  { id: "2", name: "TikTok", icon: "Music2", url: "https://tiktok.com/@psicosexvalendm", active: true },
  { id: "3", name: "YouTube", icon: "Youtube", url: "https://youtube.com/@psicosexvalendm", active: true },
  { id: "4", name: "Twitter", icon: "Twitter", url: "https://twitter.com/psicosexvalendm", active: true },
  { id: "5", name: "WhatsApp", icon: "MessageCircle", url: "https://wa.me/573001234567", active: true },
];
